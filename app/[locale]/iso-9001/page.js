...
export const metadata = { title: "ISO 9001 Quality Management" };
    ...
    <PageShell locale={locale}>
      <main className="simplePage">
        <div className="simpleInner">
          <span className="kicker">ISO 9001</span>
          <h1>Quality Management</h1>
          <p className="lead">Improve consistency, customer confidence and continual improvement through a practical quality management system.</p>
