    ...
    <main className="workspacePage">
      <style>{`
        ...
        *{box-sizing:border-box}.workspacePage{min-height:100vh;padding:25px clamp(16px,4vw,64px) 80px;background:linear-gradient(180deg,#eef4fb,#f8fafc 520px);color:var(--navy)}.workspaceShell{max-width:1720px;margin:auto}
        ...
        .field{position:relative;padding:16px;border:1px solid #dde6ef;border-radius:14px;background:#fff;transition:.2s ease}.field:hover{border-color:#b7cce2;box-shadow:0 10px 24px #071d3909}.field span{font-size:14px;line-height:1.35;letter-spacing:.005em}.field input,.field select,.field textarea{padding:10px 0;border:0;border-radius:0;background:transparent;font-size:16px;line-height:1.55}.field input::placeholder,.field textarea::placeholder{color:#75869a;opacity:1}.field input:focus,.field select:focus,.field textarea:focus{border:0;box-shadow:none}.field textarea{min-height:104px}
        .panelLead{font-size:17px!important}.section h3{font-size:20px}.check{font-size:15px}.gate span strong{font-size:15px}.gate span small{font-size:12px}
