...
export async function GET(request, { params }) {
  ...
  if (!user) {
    return Response.redirect(new URL(`/portal/login?next=/portal/health-safety/training/${id}/certificate/pdf`, request.url), 303);
  }
  ...
  pdf.setSubject("Training certificate of completion");
  pdf.setKeywords(["RPG Excellence", "training", "risk assessment", "certificate"]);
  ...
  drawCentered(page, "Professional Learning", serif, 35, height - 180, navy);
  ...
  drawCentered(page, "and achieving the required standard in the final knowledge assessment.", sans, 11, height - 366, grey);
  ...
  drawCentered(page, "Completion supports knowledge and understanding; workplace competence also requires appropriate experience and supervision.", sans, 7, 38, grey);
