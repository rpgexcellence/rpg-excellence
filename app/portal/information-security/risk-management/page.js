...
export default async function ISMSRiskPage(){
 ...
 const [riskResult,assetResult,controlResult,assessmentResult,linkResult,treatmentResult,teamResult]=await Promise.all([
